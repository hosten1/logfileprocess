...
class data_to_plot:
    ...
    def extract_and_plot_aslevels(log_file,out_path, batch_size=NATCH_SIZE*5):
        """
    ...
    # *5 是因为数据是1s一次 其他的图是6s一次
    def extract_and_plot_arlevels_recv(log_file,out_path, batch_size=NATCH_SIZE*5):
        # script_dir = os.path.dirname(os.path.abspath(__file__))
        logs_dir = out_path
    ...
    def extract_and_plot_levels_RS(log_file,out_path, batch_size=NATCH_SIZE):
        # script_dir = os.path.dirname(os.path.abspath(__file__))
    ...
    def process_rtc_status_recv_data_logs(log_file_path,out_path, interval_s=6, batch_size=NATCH_SIZE):
        """
    ...
    def process_rtc_status_send_data_logs(log_file_path,out_path, interval_s=6, batch_size=NATCH_SIZE):
        """
